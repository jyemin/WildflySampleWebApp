...
public class HelloMongoDBFromJNDIServlet extends HttpServlet {
    ...
    private void writeOutputFile(final int magicNumber, final HttpServletRequest request, final PrintWriter out) {
        ...
        out.println("<title>" + "Hello World From MongoDB from JNDI" + "</title></head>");
        out.println("<body>");
        out.println("<h1>" + "Hello World From MongoDB from JNDI " + magicNumber + "</h1>");  // Prints "Hello, world!"
